...
class Calligraph extends CalligraphBase
  ...
  subinit: ()->
    #hello!
    console.log 'Calligraph "Emitters I" init'
...
#     @haloContainer.position = {x: 0, y: 0}
    ...
    @emitter.rate = new Proton.Rate(25)
    ...
    @emitter.addBehaviour(new Proton.RandomDrift(4, 4, 0))
    ...
    @proton_renderer.onParticleCreated = (particle,b,c) =>
      ...
      if particle.parent.id is "emitter_0"
        ...
        sub.rate = new Proton.Rate(new Proton.Span(2), new Proton.Span(0.2,1))
